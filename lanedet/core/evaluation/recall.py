...
def eval_recalls(gts,
    ...
    Args:
        gts (list[ndarray]): a list of arrays of shape (n, 74)
        proposals (list[ndarray]): a list of arrays of shape (k, 74) or (k, 75)
    ...
    all_ious = []
    for i in range(img_num):
        if proposals[i].ndim == 2 and proposals[i].shape[1] == 75:
            scores = proposals[i][:, 74]
